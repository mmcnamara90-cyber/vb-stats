  ...
  return (
    <div className="min-h-svh flex items-center justify-center bg-gray-50 p-4">
      <form onSubmit={handleSubmit} className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-xl">
        <h1 className="text-2xl font-bold mb-1">VB Stats</h1>
        ...
        <input
          ...
          className="min-h-11 w-full rounded-lg border border-gray-300 px-3 mb-2 text-base focus:border-blue-500 focus:outline-none"
          autoFocus
        />
        ...
        <button
          ...
          className="min-h-11 w-full mt-2 rounded-lg bg-blue-600 text-white text-base font-medium active:bg-blue-700 disabled:opacity-50"
        >
